...
local function runMainScript()
    ...
    local Games = -- Key System Script for Roblox
-- Replace the verification URL with your actual website URL
...
local function runMainScript()
    -- Your original script logic here
    local Games = loadstring(game:HttpGet("https://raw.githubusercontent.com/TheMugenKing/Speed-Maze/refs/heads/main/2",true))()
