...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet("https://raw.githubusercontent.com/Soloeveloper/Troll-is-a-pinning-tower./refs/heads/main/TheTrollScript%20NO%20SKIDDY"))()
